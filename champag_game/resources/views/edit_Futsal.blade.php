...
<form class="container" action="/addfutsal/{{$Futsal->id}}" method="POST">
    ...
    <table style="width:60%" class="container">
        <tr>
          <th><div class="col-auto my-1">วันที่ :: <input type="date" name="date" value="{{$Futsal->date}}"></div></div></th>
          <th><div class="col-auto my-1">เวลา :: <input type="time" name="time" value="{{$Futsal->time}}"></div></th>
